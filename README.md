...
This particular Lambda function needs access to both the Internet and your VPC.
VPC is where your RDS database sits. In this case we are using Postgresql within RDS.
The Internet is used to access AWS Secrets Manager.
There is an good write up here: [Gist] (https://gist.github.com/reggi/dc5f2620b7b4f515e68e46255ac042a7)

Or I have pasted the content below:
